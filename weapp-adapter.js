...
/***/ (function (module, exports, __webpack_require__) {
  ...
  /***/ (function (module, exports) {
		...
		const pageXOffset = exports.pageXOffset = 0;
		const pageYOffset = exports.pageYOffset = 0;
		/***/
}),
  /* 3 */
  /***/ (function (module, exports, __webpack_require__) {
		...
		const HTMLElement = (function (_Element) {
			...
			_createClass(HTMLElement, [{
				...
				get: function get() {
					...
					return Number.isNaN(ret) ? _WindowProperties.innerWidth : ret
				}
			}, {
				key: 'clientHeight',
				get: function get() {
					...
					return Number.isNaN(ret) ? _WindowProperties.innerHeight : ret
				}
			}])
